...
$map = @(
    ...
    @{ s = "$pics\Showcased Archi Projects\core studio\Core Studio Ex 1\ex 1 drawing axo.png";           d = "core1-axo.jpg" }
    ...
    # Core Studio Ex 2
    @{ s = "$pics\Showcased Archi Projects\core studio\Core studio ex 2\ex 2 drawing axo section.png";    d = "core2-axo-section.jpg"; m = 2200 }
    ...
    # Core Studio Ex 3
    @{ s = "$pics\Showcased Archi Projects\core studio\Core studio ex 3\ex 3 drawing floor plan.png"; d = "core3-plan.jpg"; m = 2200 }
    @{ s = "$pics\Showcased Archi Projects\core studio\Core studio ex 3\ex 3 drawing section.png";    d = "core3-section.jpg"; m = 2200 }
    @{ s = "$pics\Showcased Archi Projects\core studio\Core studio ex 3\ex3 model.png";               d = "core3-model.jpg" }
    # Core Studio Ex 4
    ...
    @{ s = "$others\Global experience\bankok modernism trip\photo_6152020278037385592_w.jpg"; d = "bangkok-9.jpg" }
    ...
    @{ s = "$others\Personal Pictures\alumni band\photo_6152020278037385562_y.jpg"; d = "band-alumni-1.jpg" }
    @{ s = "$others\Personal Pictures\alumni band\photo_6152020278037385563_y.jpg"; d = "band-alumni-2.jpg" }
    @{ s = "$others\Personal Pictures\alumni band\photo_6152020278037385564_y.jpg"; d = "band-alumni-3.jpg" }
    @{ s = "$others\Personal Pictures\alumni band\photo_6152020278037385566_y.jpg"; d = "band-alumni-4.jpg" }
    @{ s = "$others\Personal Pictures\alumni band\photo_6152020278037385567_y.jpg"; d = "band-alumni-5.jpg" }
    @{ s = "$others\Personal Pictures\alumni band\photo_6152020278037385568_y.jpg"; d = "band-alumni-6.jpg" }
    # Personal - SUTD bands
...
Copy-Item "$pics\Spatial Design World\Untitled (800 x 800 px) (1).gif" (Join-Path $out "spatial-anim.gif") -Force
